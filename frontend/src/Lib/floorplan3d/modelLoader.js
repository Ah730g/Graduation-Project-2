...
// إعدادات الدوران التصحيحي لكل نوع أثاث (بالراديان) — تُطبَّق عند تحميل النموذج
// القيم تعتمد على اتجاه تصدير كل ملف GLB. إن ظهر الأثاث معكوساً أو جانبيّاً غيّر القيمة هنا.
// [rotationX, rotationY, rotationZ]. Y: 0، Math.PI/2 = 90°، -Math.PI/2 = -90°، Math.PI = 180°
export const FURNITURE_ROTATION_CORRECTION = {
  'sofa': [0, -Math.PI / 2, 0],   // أريكة: -90° حول Y لمواءمة اتجاه المخطط
  'bed': [-Math.PI / 2, 0, (3 * Math.PI) / 2],  // سرير: -90° X أفقياً، 270° حول Z (دورة إضافية على المحور Z)
  'chair': [0, 0, 0],              // كرسي: لا تصحيح. إن ظهر معكوساً جرب [0, Math.PI, 0] أو [0, -Math.PI/2, 0]
};
